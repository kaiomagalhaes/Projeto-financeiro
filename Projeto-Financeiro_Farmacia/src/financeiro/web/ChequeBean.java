...
import financeiro.web.util.*;

@ManagedBean(name = "chequeBean")
@RequestScoped
public class ChequeBean {

	private Cheque objeto = new Cheque();
	...
	public void cancelar() {
		...
		try {
			...
			chequeRN.cancelarCheque(this.objeto);
	...
	public Cheque getObjeto() {
		return objeto;
	}

	public void setObjeto(Cheque objeto) {
		this.objeto = objeto;
	}
