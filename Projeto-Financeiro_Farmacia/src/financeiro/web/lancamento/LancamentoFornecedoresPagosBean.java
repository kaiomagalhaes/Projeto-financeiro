...
@ManagedBean(name = "lancamentoFornecedoresPagosBean")
@ViewScoped
public class LancamentoFornecedoresPagosBean {

	private List<Lancamento> lista;
	private Lancamento editado = new Lancamento();

	public LancamentoFornecedoresPagosBean() {
	...
	public void salvar() {
		...
		lancamentoRN.salvar(this.editado, "fornecedor-pago");
