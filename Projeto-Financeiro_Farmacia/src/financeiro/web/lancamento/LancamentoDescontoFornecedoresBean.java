...
@ManagedBean(name = "lancamentoDescontoFornecedoresBean")
@ViewScoped
public class LancamentoDescontoFornecedoresBean {

	private List<Lancamento> lista;

	private Lancamento editado = new Lancamento();

	public LancamentoDescontoFornecedoresBean() {
	...
	public void salvarPorGrupo() {
		...
		lancamentoRN.salvar(this.editado,"desconto-fornecedor-grupo");
	...
	public void salvarTotal() {
		...
		lancamentoRN.salvar(this.editado,"desconto-fornecedor-total");
	...
	public void salvarPorcentagem() {
		...
		lancamentoRN.salvar(this.editado,"desconto-fornecedor-porcentagem");
	...
	public List<Lancamento> getLista() {
		...
		if (this.lista == null) {
			...
			this.lista = lancamentoRN
					.listar(conta, null, hoje.getTime(),"desconto-fornecedor-grupo");
	...
	public List<Lancamento> getListaTotal() {
		...
		if (this.lista == null) {
			...
			LancamentoRN lancamentoRN = new LancamentoRN();
			this.lista = lancamentoRN
					.listar(conta, null, hoje.getTime(),"desconto-fornecedor-total");
	...
	public List<Lancamento> getListaPorcentagem() {
		...
		if (this.lista == null) {
			...
			LancamentoRN lancamentoRN = new LancamentoRN();
			this.lista = lancamentoRN
					.listar(conta, null, hoje.getTime(),"desconto-fornecedor-porcentagem");
